...
MIMIR_URL = os.environ.get("MIMIR_URL", "http://mimir-nginx.monitoring.svc.cluster.local")
TEMPO_URL = os.environ.get("TEMPO_URL", "http://tempo-query-frontend.monitoring.svc.cluster.local:3100")
